...
public class DiGraphExtractorTest {
	...
	public void testExtract() throws Exception {
		...
		List<List<Node>> input = Lists.newArrayList(liste1,liste2,liste3,liste4,liste5,liste6,liste7);
		...
		assertThat(result.getEdges()).containsExactlyInAnyOrder(new DiEdge(node4, node5),new DiEdge(node4,node6));
